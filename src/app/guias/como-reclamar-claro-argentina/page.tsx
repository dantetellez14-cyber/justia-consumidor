...
const PAGE_PATH = "/guias/como-reclamar-claro-argentina";
...
export const metadata: Metadata = {
  title:
    "Cómo reclamar a Claro Argentina: factura, baja y portabilidad (2026)",
  description:
    "Guía paso a paso para reclamar a Claro en Argentina. Factura mal cobrada, baja imposible, sin servicio, portabilidad bloqueada. ENACOM + COPREC. Botón de baja Ley 27.250. Modelo gratis.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: "Cómo reclamar a Claro Argentina — paso a paso",
    description:
      "ENACOM + COPREC + carta documento. Modelo legal gratis para baja, portabilidad o factura disputada.",
    type: "article",
...
const faqItems = [
  {
    q: "¿Claro Argentina puede negarse a darme de baja?",
    a: "No. La Ley 27.250 obliga a tener botón de baja online y procesar la solicitud sin penalizaciones cuando se cumplió el forzoso. La baja debe efectivizarse en máximo 10 días corridos. Si Claro la traba, es infracción directa.",
  },
  {
    q: "¿Cuánto tarda una portabilidad de Claro?",
    a: "Por la Resolución 9/2014, máximo 24 horas hábiles desde que el nuevo operador la solicita. No pueden condicionarla al pago de adeudos disputados.",
  },
  {
    q: "Me cobran un servicio que cancelé. ¿Qué hago?",
    a: "Reclamo formal con número. Si en 10 días hábiles no resuelven, queja en ENACOM (defensa.enacom.gob.ar). Adjuntá comprobante de la baja. Tenés derecho a reembolso íntegro + interés punitorio (Ley 24.240 art. 31).",
  },
  {
    q: "¿Qué hago si tengo cortes de servicio frecuentes con Claro?",
    a: "Por el art. 25 de la Ley 27.078, Claro debe acreditar bonificaciones automáticas por interrupciones que excedan los plazos regulados. Si no las aplica, reclamás en ENACOM con capturas de los cortes (fecha y hora).",
  },
  {
    q: "¿Puedo cancelar el contrato sin penalidad si el servicio es deficiente?",
    a: "Sí. La Ley 24.240 (art. 10 y 17) permite resolver el contrato cuando el servicio no se presta en las condiciones pactadas. Documentá las fallas e intimá por carta documento.",
  },
  {
    q: "¿Las cláusulas que limitan mi derecho a reclamar son válidas?",
    a: "No. La Resolución 53/2003 declara abusivas las cláusulas que limitan responsabilidad de la empresa, dificultan rescisión o imponen renuncia a derechos. Aunque las firmes, son nulas de pleno derecho.",
  },
];

const howToSteps = [
  {
    name: "Atención al cliente Claro",
    text: "Llamá al *611 desde tu Claro, al 0800 444 0011 desde otro número, o entrá a Mi Claro. Pedí siempre número de reclamo. Plazo de respuesta: 5 días hábiles.",
  },
  {
    name: "Reclamo en ENACOM",
    text: "Si Claro no resuelve en 10 días hábiles, presentá reclamo gratuito en defensa.enacom.gob.ar. ENACOM es el ente regulador. Resolución estimada: 30-45 días, con plazo de 10 días hábiles para que Claro responda.",
  },
  {
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "HowTo",
      name: "Cómo reclamar a Claro Argentina",
      description:
        "Pasos legales para reclamar a Claro Argentina por factura disputada, baja imposible, portabilidad bloqueada o servicio interrumpido.",
    ...
    {
      "@type": "Article",
      headline: "Cómo reclamar a Claro Argentina paso a paso (2026)",
      datePublished: PUBLISHED,
      dateModified: UPDATED,
      ...
      <article className="mx-auto max-w-3xl px-6 py-12 text-slate-900">
        <header className="mb-10">
          <p className="mb-3 text-sm text-slate-500">
            <Link href="/guias" className="hover:underline">Guías</Link> → Argentina → Claro
          </p>
          <h1 className="text-4xl font-black leading-tight sm:text-5xl">
            Cómo reclamar a Claro Argentina paso a paso
          </h1>
        ...
        <aside className="mb-10 rounded-xl border border-amber-200 bg-amber-50 p-5">
          ...
          <p className="mt-2 text-slate-700">
            Si Claro te cobró de más, te bloqueó la portabilidad o no te
            efectiviza la baja, tenés 4 caminos legales: atención interna,
            ENACOM, COPREC y carta documento. Esta guía te lleva por todos con
            plazos, costos y modelo legal gratis.
          </p>
        </aside>

        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900">Cuándo conviene reclamar a Claro</h2>
          <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-700">
            ...
            <li>Cargos por roaming o servicios premium no contratados.</li>
          </ul>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900">Paso 1 — Atención al cliente Claro</h2>
          <ol className="mt-4 list-decimal space-y-2 pl-6 text-slate-700">
            <li><strong>*611</strong> desde tu Claro, o <strong>0800 444 0011</strong>.</li>
            <li>App <em>Mi Claro</em>.</li>
            <li>Web: claro.com.ar → "Atención al cliente".</li>
            <li><strong>Pedí número de reclamo.</strong></li>
            <li>Claro tiene <strong>5 días hábiles</strong> para responder.</li>
          </ol>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-700">
            ...
            <li>Plazo de respuesta de Claro: 10 días hábiles.</li>
        ...
        <section className="mb-12 rounded-xl border border-emerald-200 bg-emerald-50 p-6">
          ...
          <p className="mt-3 text-slate-700">
            Claro está obligada por la Ley 27.250 a tener un botón de baja online,
            sin necesidad de llamar ni ir a una oficina. Debe estar en la página
            principal y procesar la baja en máximo 10 días corridos, con
            constancia escrita inmediata.
          </p>
        </section>
...
{`A: AMX Argentina S.A. (Claro)
   CUIT: 30-66328849-7
   Domicilio: Av. de la Plata 1010, CABA
...
3) Presenté reclamo en Claro con número [folio] el día
...
y del artículo 25 de la Ley 27.078.
...
[Fecha]`}
        ...
        <GuideWaitlistCTA
          variant="footer"
          source="guia-claro-ar-footer"
          headline="JustIA está pronto"
          body="Reclamar a Claro debería tomar 5 minutos, no 5 semanas. Sumate a la lista de espera."
        />
      </article>
    </>
  );
